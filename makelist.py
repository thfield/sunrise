...
filepath = '/media/tyler/misc/files/timelapse/inprogress'
beforeafter_minutes = 4
...
def lookupTime(date):
    # returns a static time, in this case "quitting time"
    return '17:00'
...
for date in datelist:
    try:
        img_for_date = calc_times_for_date(date, lookupTime)
